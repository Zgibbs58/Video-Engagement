export const projectData = [
  {
    ...
    fullDescription: [
      ...
      "Leveraging the useEffect React hook, I orchestrated asynchronous data fetching from two APIs, employing the useState hook to manage state variables based on the API responses. The JSX code featured conditional rendering, utilizing a ternary operator to dynamically display either data-rich cards or user-friendly messages. Among our ambitious objectives was the seamless integration of image uploading within the post functionality. Recognizing the significance of enabling users to share their astronomical observations, I dedicated myself to researching and implementing Cloudinary. This involved creating a client-side widget for file selection and upload. Upon receiving the Cloudinary response containing the URL string, I stored it as a property in the MongoDB database's Blog Post model. Subsequently, when rendering posts, we showcased the stored Cloudinary images using the associated URLs.",
      "In addition to these major tasks, I actively contributed to bug fixes, implemented small features, and enhanced UI/UX, collaborating closely with my teammates. Our team's iterative development process spanned approximately 10 days, encompassing concept creation, planning, development, testing, and presentation. Through persistent teamwork, we overcame challenges and learned to navigate obstacles together, capitalizing on each other's strengths.",
    ],
