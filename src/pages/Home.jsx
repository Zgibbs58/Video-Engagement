      ...
      <section className="overflow-x-hidden overflow-y-hidden">
        <div className="mx-8 lg:mx-32">
          <motion.div
            ...
            className="flex flex-col xl:flex-row xl:justify-center xl:items-center text-left gap-16 my-48 lg:my-64"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true, amount: 0.2 }}
            className="flex flex-col justify-center items-center text-left gap-16 my-48 lg:my-64"
          >
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between gap-16">
              <div className="flex flex-col w-full lg:w-2/3 text-left gap-6 items-start">
                <p className="text-2xl lg:text-3xl font-bold">Your Trusted Guide</p>
                <p className="text-lg">
                  ...
                  on your business. I’ve helped many businesses enhance their web presence with websites that look great and convert visitors into
                  loyal customers.
                </p>
          ...
          <motion.section
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true, amount: 0.2 }}
            className="mb-48 lg:mb-64"
          >
            <p className="text-3xl lg:text-5xl font-bold text-left mb-12 md:mb-24">Success In Their Words</p>
            <Testimonials
              testimonials={[
                {
