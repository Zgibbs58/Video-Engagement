...
const StepsSection = () => {
  return (
    <div className="relative flex flex-col justify-center items-center text-center gap-8 px-8 lg:px-32 my-12 py-36 lg:py-48 lg:max-h-screen overflow-hidden">
      <div className="absolute inset-0 bg-cover bg-left-top" style={{ backgroundImage: "url('/images/stepsSection.jpeg')", clipPath: 'polygon(0 0, 100% 7%, 100% 100%, 0 100%)' }}></div>
      <div className="absolute inset-0 bg-black opacity-40" style={{clipPath: 'polygon(0 0, 100% 7%, 100% 100%, 0 100%)' }}></div>
      <h2 className="relative text-3xl lg:text-5xl font-bold text-white">How It Works</h2>
      <p className="relative text-lg text-white">Follow these four easy steps to get a professional website that works for you.</p>
      <div className="relative grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 text-[#6b7280]">
        <div className="flex flex-col items-center shadow-lg p-6 rounded-lg bg-gray-100">
        ...
        <div className="flex flex-col items-center bg-gray-100 shadow-lg p-6 rounded-lg">
