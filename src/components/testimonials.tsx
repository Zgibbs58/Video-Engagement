...
const Testimonial = ({ testimonial }) => (
  <div className="flex flex-col gap-10 md:w-1/2 w-full text-xl">
    <img className={`w-${testimonial.imgWidth}`} src={testimonial.image} alt="" />
    <div className="h-full rounded">
      ...
      <div className="flex flex-col mt-10 ml-4 justify-between">
...
const Testimonials = ({ testimonials }: TestimonialsProps) => (
    <div className="flex flex-wrap md:flex-nowrap gap-16 xl:gap-24">
